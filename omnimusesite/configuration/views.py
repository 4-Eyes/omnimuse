...
class IndexView(TemplateView):
    ...
    def _get_angular_files(self, context):
        ...
        inline_file_path = find(('configuration', r'^inline(\.[a-zA-Z0-9]{20})?\.bundle\.js$'))
        ...
        if is_production_static_files:
            ...
            scripts["main"] = "configuration/dist/main." + hash_regex.search(find(('configuration', r'^main(\.[a-zA-Z0-9]{20})?\.bundle\.js$'))).group(1) + ".bundle.js"
            scripts["polyfills"] = "configuration/dist/polyfills." + hash_regex.search(find(('configuration', r'^polyfills(\.[a-zA-Z0-9]{20})?\.bundle\.js$'))).group(1) + ".bundle.js"
            scripts["styles"] =  "configuration/dist/styles." + hash_regex.search(find(('configuration', r'^styles(\.[a-zA-Z0-9]{20})?\.bundle\.(js|css)$'))).group(1) + ".bundle.css"
        else:
