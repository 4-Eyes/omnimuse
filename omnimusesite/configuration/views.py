...
class IndexView(TemplateView):
    ...
    def _get_angular_files(self, context):
        ...
        runtime_file_path = find(r'^runtime(\.[a-zA-Z0-9]{20})?\.js$')
        ...
        if is_production_static_files:
            ...
            scripts["main"] = "configuration/dist/main." + hash_regex.search(find(r'^main(\.[a-zA-Z0-9]{20})?\.js$')).group(1) + ".js"
            scripts["polyfills"] = "configuration/dist/polyfills." + hash_regex.search(find(r'^polyfills(\.[a-zA-Z0-9]{20})?\.js$')).group(1) + ".js"
            scripts["styles"] =  "configuration/dist/styles." + hash_regex.search(find(r'^styles(\.[a-zA-Z0-9]{20})?\.(js|css)$')).group(1) + ".css"
        else:
