...
class IndexView(TemplateView):
    ...
    def _get_angular_files(self, context):
        ...
        if is_production_static_files:
            ...
            scripts["main"] = "generation/dist/main." + hash_regex.search(find(r'^main(\.[a-zA-Z0-9]{20})?\.js$')).group(1) + ".js"
            scripts["polyfills"] = "generation/dist/polyfills." + hash_regex.search(find(r'^polyfills(\.[a-zA-Z0-9]{20})?\.js$')).group(1) + ".js"
            scripts["styles"] =  "generation/dist/styles." + hash_regex.search(find(r'^styles(\.[a-zA-Z0-9]{20})?\.(js|css)$')).group(1) + ".css"
        else:
